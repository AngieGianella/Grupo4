...
!(function (t, e) {
  ...
  class mi extends W {
    ...
    _addEventListeners() {
      j.on(this._element, _i, (t) => {
        "Escape" === t.key &&
          (this._config.keyboard ? this.hide() : j.trigger(this._element, ci));
      });
    }
    static jQueryInterface(t) {
      return this.each(function () {
  ...
  class Mi extends W {
    ...
    _createTipElement(t) {
      ...
      return (
        e.setAttribute("id", i), this._isAnimated() && e.classList.add(ki), e
      );
    }
    setContent(t) {
      (this._newContent = t),
    ...
    _isAnimated() {
      return (
        this._config.animation || (this.tip && this.tip.classList.contains(ki))
      );
    }
    _isShown() {
  ...
  class Ji extends W {
    ...
    _process(t) {
      this._activeTarget !== t &&
        ...
        j.trigger(this._element, Wi, { relatedTarget: t }));
    }
    _activateParents(t) {
      if (t.classList.contains("dropdown-item"))
        K.findOne(".dropdown-toggle", t.closest(".dropdown")).classList.add(Vi);
      else
        for (const e of K.parents(t, ".nav, .list-group"))
          for (const t of K.prev(e, Yi)) t.classList.add(Vi);
    }
    _clearActiveClass(t) {
  ...
  class ws extends W {
    constructor(t) {
      super(t),
        ...
        this._parent &&
          ...
          j.on(this._element, os, (t) => this._keydown(t)));
    }
    static get NAME() {
      return "tab";
    }
    show() {
      ...
      j.trigger(t, is, { relatedTarget: e }).defaultPrevented ||
          ...
          () => {
            "tab" === t.getAttribute("role")
              ? (t.removeAttribute("tabindex"),
                ...
                j.trigger(t, ss, { relatedTarget: e }))
              : t.classList.add(fs);
          },
          t,
          ...
          () => {
            "tab" === t.getAttribute("role")
              ? (t.setAttribute("aria-selected", !1),
                ...
                j.trigger(t, es, { relatedTarget: e }))
  ...
  j.on(document, ns, bs, function (t) {
    ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
      d(this) || ws.getOrCreateInstance(this).show();
  }),
    j.on(window, rs, () => {
          ...
          this._queueCallback(
            () => {
              this._element.classList.add(Is),
                this._element.classList.remove(Ns, Ds),
                j.trigger(this._element, Ss);
            },
            this._element,
            this._config.animation
          )));
